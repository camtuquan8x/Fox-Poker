            ...
            if (reader.Token == JsonToken.ArrayStart) {
                ...
                while (true) {
                    ...
                    if (t_data.Properties.ContainsKey (property)) {
                        ...
                        {
                            // 2012-07-19 RMG:
                            // We shouldn't throw an exception just because the json data has a field that our class doesn't have.
                             ...
                             */
                            // Read past the next value
                            ReadValue(delegate { return new JsonData(); }, reader);
                        }
                        else
                        {
